...
class RaritySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Rarity
        fields = ['id', 'game_id', 'rarity_name', 'chance',
                  'pity', 'softpity', 'softpitychance', 'color']


class ItemSerializer(serializers.ModelSerializer):
    rarity_id = serializers.PrimaryKeyRelatedField(
        source='rarity', queryset=Rarity.objects.all())
