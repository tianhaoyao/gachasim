<template>
    ...
    <form @submit="submitForm">
        ...
        rate:{{ form.rarity }} chance{{ form.chance }}
        game: {{ form.game }} softpity: {{ form.softpity }}
        softpitychance: {{ form.softpitychance }}
        color: {{ form.color }}
...
export default {
    ...
    methods: {
        submitForm(event) {
            ...
            if (this.includeSoftPity && !this.form.softpitychance || this.includeSoftPity && !this.form.softpity) {
